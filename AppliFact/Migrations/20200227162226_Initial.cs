        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RaisonSocile = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RaisonSociale = table.Column<string>(nullable: false),
                    Adresse = table.Column<string>(nullable: false),
                    CodePostal = table.Column<string>(nullable: false),
                    Ville = table.Column<string>(nullable: false),
                    Pays = table.Column<string>(nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    RaisonSocile = table.Column<string>(nullable: true),
                    Logo = table.Column<byte[]>(nullable: true),
                    Adresse = table.Column<string>(nullable: true),
                    CodePostal = table.Column<string>(nullable: true),
                    Ville = table.Column<string>(nullable: true),
                    Pays = table.Column<string>(nullable: true),
                    NumeroFacture = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Factures_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Factures_ApplicationUserId",
                table: "Factures",
