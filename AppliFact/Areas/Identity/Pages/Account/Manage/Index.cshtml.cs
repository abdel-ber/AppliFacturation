...
namespace AppliFact.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(ApplicationUser user)
        {
            ...
            {
                Raisonsociale=user.RaisonSocile,
                Logo=user.Logo,
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.Raisonsociale != user.RaisonSocile)
            {
                user.RaisonSocile = Input.Raisonsociale;
            }
            if (Input.Logo != user.Logo)
            {
